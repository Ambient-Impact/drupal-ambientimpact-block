...
class SocialLinks extends BlockBase implements BlockPluginInterface {
  ...
  public function defaultConfiguration() {
    ...
    // Remove these keys as we shouldn't save them. The langcode specifically
    // would be redundant as Drupal already saves the block language in the
    // config for us.
  ...
  public function build() {
    ...
    // Add classes to the block to target the alignment on both the list and the
    // block title.
    ...
    $renderArray['social_links'] = [
      ...
      // Pass the base BEM class as a variable so that we don't have to define
  ...
  public function blockForm($form, FormStateInterface $formState) {
    ...
    $form['social_networks'] = [
      ...
      // The table containing the individual social networks. This has table
      // drag functionality.
      'networks'  => [
        '#type'     => 'table',
        '#header'     => [
        ...
        '#tabledrag' => [
          [
            ...
            // drag needs this to know what field to save the updated weight
            // to.
  ...
  public function blockSubmit($form, FormStateInterface $formState) {
    ...
    // Not sure if Drupal strips out values that weren't in the form, so only
    // save values that are already present in the config to be safe.
